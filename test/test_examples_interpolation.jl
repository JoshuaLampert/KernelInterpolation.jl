...
@testitem "interpolation_1d_discontinuous.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_exact.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
    @test_include_example(joinpath(EXAMPLES_DIR, "interpolation_2d_exact.jl"),
                          l2=0.0, linf=0.0)
end

@testitem "interpolation_2d_sphere.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
    @test_include_example(joinpath(EXAMPLES_DIR, "interpolation_2d_sphere.jl"),
                          l2=1.0227617845926844, linf=0.2456367616554671)
end

@testitem "interpolation_2d_L_shape.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
    @test_include_example(joinpath(EXAMPLES_DIR, "interpolation_2d_L_shape.jl"),
                          l2=2.116432713457176, linf=0.3412754879687297)
end

@testitem "interpolation_2d_polynomials.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_transformation.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_product_kernel.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_sum_kernel.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_Riesz_kernel.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
...
@testitem "interpolation_2d_convergence.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
    @test_include_example(joinpath(EXAMPLES_DIR, "interpolation_2d_convergence.jl"),
                          ns=5:10)
end

@testitem "interpolation_2d_condition.jl" setup=[Setup, AdditionalImports, InterpolationExamples] begin
