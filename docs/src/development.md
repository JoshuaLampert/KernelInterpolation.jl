...
KernelInterpolation.jl is an open-source project, and we are very happy to accept contributions from the community. You can contribute by opening an issue or a pull request (PR).
